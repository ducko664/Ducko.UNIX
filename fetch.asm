...
int main(int argc, char *argv[]) {
   ...
   f:	e8 bf 03 00 00       	call   3d3 <getproccount>
  ...
  dd:	58                   	pop    %eax
  de:	5a                   	pop    %edx
  df:	68 54 09 00 00       	push   $0x954
  e4:	6a 01                	push   $0x1
  e6:	e8 a5 03 00 00       	call   490 <printf>

    exit();
  eb:	e8 43 02 00 00       	call   333 <exit>
 ...
 3f8:	89 d1                	mov    %edx,%ecx
{
 ...
 42b:	0f b6 92 d8 09 00 00 	movzbl 0x9d8(%edx),%edx
 ...
 499:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 504:	ff 24 85 80 09 00 00 	jmp    *0x980(,%eax,4)
 ...
 610:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 615:	bb 8a 08 00 00       	mov    $0x88a,%ebx
...
free(void *ap)
{
 ...
 621:	a1 78 0c 00 00       	mov    0xc78,%eax
{
 ...
 65f:	5b                   	pop    %ebx
  freep = p;
 660:	a3 78 0c 00 00       	mov    %eax,0xc78
}
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 667:	5d                   	pop    %ebp
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 78 0c 00 00       	mov    %eax,0xc78
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 78 0c 00 00    	mov    0xc78,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6fb:	3b 05 78 0c 00 00    	cmp    0xc78,%eax
 ...
 71e:	e8 fd fe ff ff       	call   620 <free>
  return freep;
 723:	8b 15 78 0c 00 00    	mov    0xc78,%edx
 ...
 74c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 74f:	89 15 78 0c 00 00    	mov    %edx,0xc78
}
 ...
 75f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 78 0c 00 00 7c 	movl   $0xc7c,0xc78
 767:	0c 00 00 
    base.s.size = 0;
 76a:	b8 7c 0c 00 00       	mov    $0xc7c,%eax
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 7c 0c 00 00 7c 	movl   $0xc7c,0xc7c
 776:	0c 00 00 
    base.s.size = 0;
 779:	c7 05 80 0c 00 00 00 	movl   $0x0,0xc80
 780:	00 00 00 
    if(p->s.size >= nunits){
