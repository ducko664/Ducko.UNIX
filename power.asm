...
int main(int argc, char *argv[]) {
  ...
  1b:	50                   	push   %eax
  1c:	50                   	push   %eax
  1d:	68 1f 08 00 00       	push   $0x81f
  22:	ff 73 04             	push   0x4(%ebx)
  25:	e8 d6 00 00 00       	call   100 <strcmp>
  2a:	83 c4 10             	add    $0x10,%esp
  2d:	85 c0                	test   %eax,%eax
  2f:	75 2e                	jne    5f <main+0x5f>
  ...
  3a:	e8 31 04 00 00       	call   470 <printf>
        sleep(110);
  3f:	c7 04 24 6e 00 00 00 	movl   $0x6e,(%esp)
  46:	e8 58 03 00 00       	call   3a3 <sleep>

        // Pass '1' to tell the kernel to reset the CPU
        reboot(1); 
  4b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  52:	e8 64 03 00 00       	call   3bb <reboot>
  57:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  5a:	e8 b4 02 00 00       	call   313 <exit>
    else if (strcmp(argv[1], "shutdown") == 0) {
  5f:	51                   	push   %ecx
  60:	51                   	push   %ecx
  61:	68 26 08 00 00       	push   $0x826
  66:	ff 73 04             	push   0x4(%ebx)
  69:	e8 92 00 00 00       	call   100 <strcmp>
  6e:	83 c4 10             	add    $0x10,%esp
  71:	85 c0                	test   %eax,%eax
  73:	75 3e                	jne    b3 <main+0xb3>
        printf(1, "Shutting down DUCKO.UNIX cleanly. Goodbye!\n");
  75:	52                   	push   %edx
  76:	52                   	push   %edx
  77:	68 c0 07 00 00       	push   $0x7c0
  7c:	6a 01                	push   $0x1
  7e:	e8 ed 03 00 00       	call   470 <printf>
        sleep(110);
  83:	c7 04 24 6e 00 00 00 	movl   $0x6e,(%esp)
  8a:	e8 14 03 00 00       	call   3a3 <sleep>
        reboot(2); 
  8f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  96:	e8 20 03 00 00       	call   3bb <reboot>
  9b:	83 c4 10             	add    $0x10,%esp
  9e:	eb ba                	jmp    5a <main+0x5a>
        printf(2, "Usage: power [reboot|shutdown]\n");
  a0:	50                   	push   %eax
  a1:	50                   	push   %eax
  a2:	68 78 07 00 00       	push   $0x778
  a7:	6a 02                	push   $0x2
  a9:	e8 c2 03 00 00       	call   470 <printf>
        exit();
  ae:	e8 60 02 00 00       	call   313 <exit>
        printf(2, "Unknown power option. Use 'reboot' or 'shutdown'.\n");
  b3:	50                   	push   %eax
  b4:	50                   	push   %eax
  b5:	68 ec 07 00 00       	push   $0x7ec
  ba:	6a 02                	push   $0x2
  bc:	e8 af 03 00 00       	call   470 <printf>
  c1:	83 c4 10             	add    $0x10,%esp
  c4:	eb 94                	jmp    5a <main+0x5a>
  c6:	66 90                	xchg   %ax,%ax
  c8:	66 90                	xchg   %ax,%ax
  ca:	66 90                	xchg   %ax,%ax
  cc:	66 90                	xchg   %ax,%ax
 ...
 3d8:	89 d1                	mov    %edx,%ecx
{
 ...
 40b:	0f b6 92 90 08 00 00 	movzbl 0x890(%edx),%edx
 ...
 479:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4e4:	ff 24 85 38 08 00 00 	jmp    *0x838(,%eax,4)
 ...
 5f0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5f5:	bb 2f 08 00 00       	mov    $0x82f,%ebx
 ...
 601:	a1 30 0b 00 00       	mov    0xb30,%eax
{
 ...
 63f:	5b                   	pop    %ebx
  freep = p;
 640:	a3 30 0b 00 00       	mov    %eax,0xb30
}
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
 647:	5d                   	pop    %ebp
 ...
 656:	72 ce                	jb     626 <free+0x26>
{
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 30 0b 00 00       	mov    %eax,0xb30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 30 0b 00 00    	mov    0xb30,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6db:	3b 05 30 0b 00 00    	cmp    0xb30,%eax
 ...
 6fe:	e8 fd fe ff ff       	call   600 <free>
  return freep;
 703:	8b 15 30 0b 00 00    	mov    0xb30,%edx
 ...
 72c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 72f:	89 15 30 0b 00 00    	mov    %edx,0xb30
}
 ...
 73f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 30 0b 00 00 34 	movl   $0xb34,0xb30
 747:	0b 00 00 
    base.s.size = 0;
 74a:	b8 34 0b 00 00       	mov    $0xb34,%eax
    base.s.ptr = freep = prevp = &base;
