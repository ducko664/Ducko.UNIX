...
int main(int argc, char *argv[]) {
   ...
   e:	83 ec 0c             	sub    $0xc,%esp
    printf(1, "Thanks for using my OS!!!\n");
  ...
  1d:	58                   	pop    %eax
  1e:	5a                   	pop    %edx
  1f:	68 f3 06 00 00       	push   $0x6f3
  24:	6a 01                	push   $0x1
  26:	e8 a5 03 00 00       	call   3d0 <printf>
    exit(); // unix things must end in exit!!! never firget
 ...
 3d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 550:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 555:	bb fe 06 00 00       	mov    $0x6fe,%ebx
...
free(void *ap)
{
 ...
 561:	a1 fc 09 00 00       	mov    0x9fc,%eax
{
 ...
 59f:	5b                   	pop    %ebx
  freep = p;
 5a0:	a3 fc 09 00 00       	mov    %eax,0x9fc
}
 5a5:	5e                   	pop    %esi
 5a6:	5f                   	pop    %edi
 5a7:	5d                   	pop    %ebp
 ...
 5b6:	72 ce                	jb     586 <free+0x26>
{
 ...
 5d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5da:	a3 fc 09 00 00       	mov    %eax,0x9fc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 5f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5fc:	8b 15 fc 09 00 00    	mov    0x9fc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 63b:	3b 05 fc 09 00 00    	cmp    0x9fc,%eax
 ...
 65e:	e8 fd fe ff ff       	call   560 <free>
  return freep;
 663:	8b 15 fc 09 00 00    	mov    0x9fc,%edx
 ...
 68c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 68f:	89 15 fc 09 00 00    	mov    %edx,0x9fc
}
 ...
 69f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6a0:	c7 05 fc 09 00 00 00 	movl   $0xa00,0x9fc
 6a7:	0a 00 00 
    base.s.size = 0;
 6aa:	b8 00 0a 00 00       	mov    $0xa00,%eax
    base.s.ptr = freep = prevp = &base;
 6af:	c7 05 00 0a 00 00 00 	movl   $0xa00,0xa00
 6b6:	0a 00 00 
    base.s.size = 0;
 6b9:	c7 05 04 0a 00 00 00 	movl   $0x0,0xa04
 6c0:	00 00 00 
    if(p->s.size >= nunits){
